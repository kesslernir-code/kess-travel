...
חוקים:
1. חלק את המקומות ל-N ימים (N = מספר הימים בקלט). כל יום קוהרנטי גיאוגרפית — מקומות מאותו אזור/קרובים באותו יום, לא לקפוץ בין קצוות המדינה באותו יום. **אם ניתן "מספר ימים שנקבע ידנית לכל אזור" בקלט — זו הגבלה מחייבת, לא המלצה: הקצה בדיוק את מספר הימים שצוין לכל אזור (למשל אם נקבע 2 ימים לאזור X, בדיוק 2 מהימים הכוללים יוקדשו לאזור הזה), וסדר את הימים כך שאזורים גיאוגרפית סמוכים יבואו ברצף.** **היום האחרון, אם הוא יום טיסת חזרה, הוא גורם נפרד ולא צריך "לינה" משלו — אינו חייב להיכלל בסכום ימי האזורים (למשל: 4 ימים שהוקצו לאזור אחד + יום טיסה אחרון = טיול של 5 ימים, וזה תקין, לא חוסר בהקצאה).**
